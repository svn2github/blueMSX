...
#define BIT_SCSI2			0x01
#define BIT_SCSI2_ONLY		0x02
#define BIT_SCSI3			0x04

#define	MODE_SCSI1			0x00
#define	MODE_SCSI2			0x03
#define MODE_SCSI3			0x05
#define	MODE_UNITATTENTION	0x08	// report unit attention
#define	MODE_MEGASCSI		0x10	// report disk change when call of
									// 'test unit ready'
#define	MODE_FDS120			0x20	// change of inquiry when inserted floppy image
#define	MODE_CHECK2			0x40	// mask to diskchange when load state
#define	MODE_REMOVABLE		0x80
